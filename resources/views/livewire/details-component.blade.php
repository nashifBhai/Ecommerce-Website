                ...
                <div class="wrap-product-detail">
                    ...
                    <div class="detail-info">
                        ...
                        <div class="wrap-butons">
                            @if($product->sale_price >0 && $sale->status ==1 && $sale->sale_date > Carbon\Carbon::now())
                            <a href="#" class="btn add-to-cart" wire:click.preven="store({{$product->id}},'{{$product->name}}', {{$product->sale_price}})">Add to Cart</a>
                            @else
                            <a href="#" class="btn add-to-cart" wire:click.preven="store({{$product->id}},'{{$product->name}}', {{$product->regular_price}})">Add to Cart</a>
