...
<body class="home-page home-01 ">
						...
						<div class="wrap-icon right-section">
							<div class="wrap-icon-section wishlist">
								<a href="#" class="link-direction">
									...
									<div class="left-info">
										@if (Cart::instance('wish-list')->count() > 0)
										<span class="index">{{ Cart::instance('wish-list')->count() }} item</span>	
										@endif
	...
	<script src="https://cdn.tiny.cloud/1/tlyuuy9t8fb4n5kae6bgw0bhaa8sgp4546x714qb2oupywac/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
